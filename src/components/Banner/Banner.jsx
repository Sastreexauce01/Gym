...
Banner.propTypes = {
  image: PropTypes.string.isRequired, // L'image doit être une string et obligatoire
  title: PropTypes.string.isRequired, // Titre obligatoire
  subtitle: PropTypes.string, // Sous-titre optionnel
  link: PropTypes.string, // Lien optionnel
};
